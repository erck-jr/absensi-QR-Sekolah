            ...
            <div class="bg-white  overflow-hidden shadow-sm sm:rounded-lg p-6 text-center">
                ...
                @if($teacher->photo)
                    <div class="flex justify-center mb-4">
                        <img src="{{ asset('storage/photo/teachers/' . $teacher->photo) }}" alt="Foto Guru" class="w-32 h-32 object-cover rounded-full border-2 border-gray-300">
                    </div>
                @endif
                <h3 class="text-2xl font-bold mb-2 ">{{ $teacher->name }}</h3>
                <p class="text-gray-600  mb-6">{{ $teacher->nuptk }}</p>
                ...
                <div class="mt-6 border-t pt-6 ">
                    <a href="{{ route('teachers.index') }}" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2      ">Kembali</a>
