<x-app-layout>
    <x-slot name="title">Tambah Shift</x-slot>
    <x-slot name="header">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-material-card title="Tambah Shift Baru" icon="add_alarm" color="blue">
                <form action="{{ route('shifts.store') }}" method="POST">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="time" id="check_out_time" name="check_out_time" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        </div>
                        <div>
                            <label for="late_check_in_minute" class="block mb-2 text-sm font-medium text-gray-900">Toleransi Terlambat (Menit)</label>
                            <input type="number" id="late_check_in_minute" name="late_check_in_minute" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required value="15">
                        </div>
                    </div>
