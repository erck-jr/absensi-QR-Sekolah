            ...
            <x-material-card title="Edit Tingkat" icon="edit" color="indigo">
                <form action="{{ route('levels.update', $level->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="level_order" name="level_order" value="{{ old('level_order', $level->level_order) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5" required min="0">
