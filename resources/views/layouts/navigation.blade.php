                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('academic.year.index')">{{ __('Tahun Ajaran Baru') }}</x-dropdown-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div x-data="{ open: false }" class="border-t border-navy-800">
                ...
                <div x-show="open" class="ps-4 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('academic.year.index')" :active="request()->routeIs('academic.year.*')">{{ __('Tahun Ajaran Baru') }}</x-responsive-nav-link>
